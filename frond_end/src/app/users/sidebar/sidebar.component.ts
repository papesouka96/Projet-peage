...
export const ROUTES: RouteInfo[] = [
    { path: '/acceuil', title: 'ACCEUIL',  icon: 'fa fa-home', class: '' },
    { path: '/transaction', title: 'TRANSACTION',  icon:'fa fa-map-marker', class: '' },
    { path: '/liste_agent', title: 'LISTE AGENT',  icon:'fa fa-history', class: '' },
    { path: '/profil', title: 'PROFIL',  icon:'fa fa-history', class: '' },
    { path: '/ajout_agent', title: 'AJOUT AGENT',  icon:'fa fa-history', class: '' },
    { path: '/abonnement', title: 'ABONNEMENT',  icon:'fa fa-history', class: '' },
